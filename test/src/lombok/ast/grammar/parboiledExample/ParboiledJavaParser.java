...
@BuildParseTree
public class ParboiledJavaParser extends BaseParser<Object> {
  ...
  Rule Letter() {
      ...
      return FirstOf(Sequence('\\', UnicodeEscape()), new ParboiledJavaLetterMatcher());
  }
  ...
  Rule LetterOrDigit() {
      ...
      return FirstOf(Sequence('\\', UnicodeEscape()), new ParboiledJavaLetterOrDigitMatcher());
  }
